                     ...
                     <div class="form-group col-md-4">
                        <label for="">Semester</label>
                            <input type="number" name="semester"
                                ...
                                placeholder="sekarang anda semester berapa?" value="{{ old('semester') }}">
                    ...
                    <div class="form-group col-md-4">
                        <label for="">Angkatan</label>
                            <input type="number" name="angkatan"
                                class="form-control @error('angkatan') is-invalid @enderror" id=""
                                placeholder="anda angkatan tahun berapa?" value="{{ old('angkatan') }}">
                                <small class="text-muted">Masukkan angkanya saja, contoh: 2019</small>
                                    @error('angkatan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <p class="font-weight-bold mt-3 bg-info ">C. Input Mata Kuliah</p>

                                    <p>Silahkan isi mata kuliah yang ingin dikonversikan:</p>
...
@foreach($matkuls as $matkul)
    <input type="checkbox" name="matkul[]" value="{{ $matkul->id_matkul }}" data-sks="{{ $matkul->jumlah_sks }}" onchange="calculateTotalSKS()">
    <label>{{ $matkul->nama_matkul }} ({{ $matkul->jumlah_sks }} SKS)</label>
    <br>
@endforeach
<br>
<!-- Total SKS -->
<label for="totalSKS">Total SKS:</label>
<span id="totalSKS">{{ session('totalSKS', 0) }}</span> SKS
<br>
...
<script>
    ...
    function calculateTotalSKS() {
        ...
        for (var i = 0; i < checkboxes.length; i++) {
            if (checkboxes[i].checked) {
                totalSKS += parseInt(checkboxes[i].getAttribute('data-sks'));
            }
        }
    ...
    function validateForm() {
        ...
        // Cek apakah minimal satu checkbox tercentang
        ...
        // Jika tidak ada checkbox yang tercentang, tampilkan pesan alert
        if (!atLeastOneChecked) {
            alert('Minimal harus ada 1 mata kuliah yang dicentang.');
